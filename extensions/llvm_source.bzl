...
_DEFAULT_SOURCE_PATCHES = [
    ...
    "//3rd_party/llvm-project/x.x/patches:sched-class-table-pooling.patch",
    ...
    "//3rd_party/llvm-project/x.x/patches:dagisel-two-child-scopes.patch",
    ...
    "//3rd_party/llvm-project/x.x/patches:clang-opencl-builtin-metadata.patch",
    ...
    "//3rd_party/llvm-project/x.x/patches:lld-elf-mark-live-outlining.patch",
...
_LLVM_21_SOURCE_PATCHES = _DEFAULT_SOURCE_PATCHES + [
    ...
    "//3rd_party/llvm-project/21.x/patches:vector-library-descriptors.patch",
